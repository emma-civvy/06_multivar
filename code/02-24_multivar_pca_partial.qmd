...
## every PC has all variables, weighted by how important they are to PC. 
## Interpret as day length in seasons perhaps. 
...
PC1 ~ sum_precip_oct x coefficient +
  mean_daylength_jan x coefficient -> creates PC score
```{r PC1 vs PC2}
...
ggplot(data = weather_postpca,
  ...
  geom_point()+
  geom_smooth() ## PC1 not explaining much of fiber strength
